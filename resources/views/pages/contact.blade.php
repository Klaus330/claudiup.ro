            ...
            <div class="row contact">
                ...
                <div class="col s12 m5 l3 xl3 leftside">
                    ...
                    <ul class="flex justify-around">
                        <li class="font-weight-400 second-font">
                            <a href="https://www.linkedin.com/in/popa-claudiu-a0592a168/" target="_blank">
                                <i class="fa fa-linkedin is-gray"></i>
                            </a>
                        </li>
                        <li class="font-weight-400 second-font">
                            <a href="https://github.com/Klaus330" target="_blank">
                                <i class="fa fa-github is-gray"></i>
                            </a>
                        </li>
                    </ul>
                 </div>
                ...
                <div class="col s12 m7 l9 xl9 rightside">
                    <h6 class="uppercase m-none">Feel free to drop a line</h6>
                    <div class="row">
