    ...
    <div class="row">
        ...
        <div class="col s12 l6 xl6">
            <div class="carousel carousel-slider">
                @foreach ($projects[$i]->images as $image)
                    <a class="carousel-item" href="#one!" id="{{$image->id}}">
                        <img class="responsive-img" src="/images/projects/{{$image->location}}" alt="{{$projects[$i]->title}}" >
                    </a>
                @endforeach
            </div>
        </div>
             ...
             <h3 class="font-weight-600 white-text uppercase">{{$projects[$i]->title}}</h3>
              <ul class="project-details white-text second-font">
                ...
                <li>
                    ...
                    <span class="font-weight-600"> Used Technologies</span> : 
